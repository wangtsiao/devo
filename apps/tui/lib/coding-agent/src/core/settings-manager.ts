...
export interface Settings {
	...
	bundledSkills?: BundledSkillsSettings; // Configure built-in skills shipped with Devo
	enableBuiltinSkills?: boolean; // default: true - load built-in skills shipped with Devo
