...
export const APP_NAME: string = "devo";
export const APP_TITLE: string = "devo";
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".devo";
export const VERSION: string = pkg.version || "0.0.0";

// e.g., DEVO_CODING_AGENT_DIR (from piConfig.name) or PI_CODING_AGENT_DIR
...
// =============================================================================
// User Config Paths (~/.devo/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.devo/) */
...
/** Directory where daemon and client diagnostic logs are written (e.g. ~/.devo/logs/). */
