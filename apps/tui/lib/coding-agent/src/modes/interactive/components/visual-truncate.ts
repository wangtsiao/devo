...
/**
 * Truncate text to a maximum number of visual lines from the start (head).
 * Used for long dumps where the beginning is the useful preview (e.g. system prompt).
 */
export function truncateToVisualLinesHead(
	text: string,
	maxVisualLines: number,
	width: number,
	paddingX: number = 0,
